                        ...
                        <div className="footer-logo">
                            ...
                            <div className="social-icon d-flex mt-4">
                                <div className="facebook-icon footer-icon">
                                    <Link href="https://www.facebook.com/msmeemtraders/" target="”_blank”"><i className="bx bxl-facebook"></i></Link>
                                </div>
                                <div className="twitter-icon footer-icon">
                                    <Link href="#" target="”_blank”"><i className="bx bxl-twitter"></i></Link>
                                </div>
                                ...
                                <div className="linkedin-icon footer-icon">
                                    <Link href="https://www.linkedin.com/in/khokon-iqbal-b72335188" target="”_blank”"><i className="bx bxl-linkedin"></i></Link>
                                </div>
                            </div>
                        </div>
            ...
            <div className="container">
                <div className="row d-flex justify-content-between">
                    ...
                    <div className="col-auto">
                        <p className="mb-0 py-2">Developed by <a href="https://www.facebook.com/shaonlimit/" target="_blank" rel="noreferrer">Saiful Islam
                                Shaon</a></p>
                    </div>
                </div>
            </div>
